...
dir0='C:/Users/User/Documents/11,12'
os.chdir(dir0)
total_file=0
...
for io in range(len(list_dir0)):
    ...
    for i in range(len(list_dir)):
        dir10=dir1+'/'+str(list_dir[i])
        os.chdir(dir10)
        list_dir12=os.listdir()
        for jkl in range(len(list_dir12)):
            dir11=dir10+'/'+str(list_dir12[jkl])
            os.chdir(dir11)
            list_dir13=os.listdir()
            print(list_dir13)
            listdir_3=list_dir13
...
print('Count of Non Perfect reading', len(file_low_list))
...
for io in range(len(list_dir0)):
    ...
    for i in range(len(list_dir)):
        ...
        for jkl in range(len(list_dir12)):
            ...
            if len(listdir_3)!=0:
                os.rename(listdir_3[0],str(listdir_3[0][:-4])+'_English.txt')
                os.rename(listdir_3[1],str(listdir_3[1][:-4])+'_Hindi.txt')
