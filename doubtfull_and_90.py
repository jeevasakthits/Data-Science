...
for io in range(len(list_dir0)):
    ...
    for j in range(len(list_dir)):
        ...
        frames = [correct_one, doubtful]
        result = pd.concat(frames)
        correct_one.to_excel('90_percent_correct_Parallel_corpora.xlsx',index=False)
        result.to_excel('80_percent_correct_Parallel_corpora.xlsx',index=False)
'''
